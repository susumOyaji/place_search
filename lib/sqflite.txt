...
int a = 10;
int b = 12;
String result_message1 = 'The sum of a and b is ${a+b}';
...
//Flutterはマルチ・プラットフォームのUIツールキットです. AndroidとiOSではファイルの構成などは当然違います. 
//getDatabasesPathでデータベースの保存フォルダへのパスを取得できます.
